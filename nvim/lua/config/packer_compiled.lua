...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'surround.nvim', 'bufferline.nvim', 'gitsigns.nvim', 'vim-matchup', 'hop.nvim', 'vim-gutentags', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
